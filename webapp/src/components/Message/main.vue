...
<div class="tips" v-if="isShow">
	<div v-if="type === 'success' " class="success-tip">
		<svg class="icon" aria-hidden="true" style="font-size : 0.2rem;width:0.3rem;height: 0.3rem">
                            <use  xlink:href="#icon-success1"></use>
                        </svg> {{message}}
	</div>
	<div v-if="type === 'warn' " class="warn-tip">
		<svg class="icon" aria-hidden="true" style="font-size : 0.2rem;width:0.3rem;height: 0.3rem;display: inline">
                            <use  xlink:href="#icon-warn1"></use>
                        </svg><div style="display: inline">{{message}}</div>
	</div>
